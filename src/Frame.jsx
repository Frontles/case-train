...
function Frame() {
    return (
        <div className="hidden lg:flex flex-col lg:basis-2/6 w-auto ml-4 py-4  " >
            <img src={Profile4} className=" rounded-2xl object-cover w-full h-full object-center" alt="person" />
