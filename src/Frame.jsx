...
function Frame() {
    return (
        <div className="flex flex-col basis-1/12 w-auto  " >
            ...
            <div className="flex flex-col">
                <div className="flex flex-col pt-4 w-72 ">
                    ...
                    <p className="text-StateGray" style={{ fontSize: "14px" }}>Last appointment: 12.01.2023</p>
                    <p className="text-StateGray" style={{ fontSize: "14px" }}>Next appointment: 12.05.2023 </p>
                </div>

                <div className="flex flex-col pt-4 w-72 ">
                    <p className="text-PrimaryNavy font-medium">Diagnoses</p>
                    <p className="text-StateGray border-b py-3 flex space-x-2" style={{ fontSize: "14px" }} >
                        <span>A00.1</span><span>Kolera, Vibrio cholerae 01, biovar eltor’a bağlı</span>
                    </p>
                    <p className="text-StateGray py-3 flex space-x-2" style={{ fontSize: "14px" }} >
                        <span>A00.1</span><span>Kolera, Vibrio cholerae 01, biovar eltor’a bağlı</span>
                    </p>
                </div>
